...
async def create_video_with_images(text, speaker_data, speaker_images, supported_voices, video_format, video_quality):
    ...
    try:
        ...
        quality_map = {
            "HD 720p": (720, 1280),    # 9:16 แนวตั้ง
            "Full HD 1080p": (1080, 1920),  # 9:16 แนวตั้ง
            "SD 480p": (480, 854)      # 9:16 แนวตั้ง
        }
        ...
        # ตั้งค่า codec ตามรูปแบบ
        if video_format == "MP4":
            final_video.write_videofile(output_video, fps=24, codec='libx264', verbose=False, logger=None)
        elif video_format == "AVI":
            final_video.write_videofile(output_video, fps=24, codec='libxvid', verbose=False, logger=None)
        elif video_format == "MOV":
            final_video.write_videofile(output_video, fps=24, codec='libx264', verbose=False, logger=None)
        elif video_format == "WebM":
            final_video.write_videofile(output_video, fps=24, codec='libvpx', verbose=False, logger=None)
